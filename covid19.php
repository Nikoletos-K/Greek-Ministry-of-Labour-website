            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="submenu1" aria-expanded="false">
                    <ul class="flex-column pl-2 nav">
                        ...
                        <!-- <li class="nav-item">
                            <a class="nav-link collapsed py-1" href="#submenu1sub1" data-toggle="collapse" data-target="#submenu1sub1"><span>Άλλα θέματα</span></a>
                            <div class="collapse" id="submenu1sub1" aria-expanded="true">
                                <ul class="flex-column nav pl-4">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link p-1" href="#">
                                            <i class="fa fa-fw fa-dashboard"></i>Ευπαθείς ομάδες</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link p-1" href="#">
            ...
            <div class="tab-pane active show" id="genikes-odhgies">
              <div class="row">
                ...
                <ul class="col-lg-4 text-center order-1 order-lg-2" style="list-style-type:none;">
                  <!-- <li><div>
                    <img src="assets/img/menoume_asfalois.png" alt="" class="" style="width:240px;height:240px;">
                  </div></li>
                  <br><br> -->
                  <!-- <li><div class="col-lg-11 order-1 order-lg-2 phone alert alert-warning" role="alert">
                    <h4>Προσοχή: </h4>
                    <p> 
                          ...
                          <ul class="text-in-covid" style="list-style-type: none;">
                            ...
                            <ol>
                              ...
                              <ol style="list-style-type: lower-greek;">
                                ...
                                <li>να θέτουν για πρώτη φορά σε αναστολή συμβάσεις εργασίας εργαζομένων τους.
                                </li> <br>
                      ...
                      <div class="panel panel-default">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                          <div class="panel-body">
                            ...
                            <p>
                              Ο εργοδότης μπορεί να αποφασίσει ότι η εργασία που παρέχεται από τον εργαζόμενο στον προβλεπόμενο από την ατομική του σύμβαση τόπο εργασίας, θα πραγματοποιείται με το σύστημα της εξ αποστάσεως εργασίας. <b>Οι εργαζόμενοι που ανήκουν σε ευπαθείς ομάδες</b> , δικαιούνται να ζητήσουν να εργάζονται εξ αποστάσεως . Το σχετικό αίτημα, μπορεί να διατυπώνεται κάθε πρόσφορο μέσο, όπως μέσω τηλεφώνου, ηλεκτρονικού ταχυδρομείου ή γραπτού μηνύματος κινητού τηλεφώνου.
                            </p>
            ...
            <div class="tab-pane" id="adeia">
              <div class="row">
                <div class="col-lg-12 details order-2 order-lg-1">
                  ...
                  <ul>
                    <li>
                      παιδιών που είναι εγγεγραμμένα σε βρεφικούς, βρεφονηπιακούς και παιδικούς σταθμούς,
                    </li>

                    <li>
                      παιδιών που φοιτούν σε σχολικές μονάδες υποχρεωτικής εκπαίδευσης (Νηπιαγωγείο, Δημοτικό, Γυμνάσιο),
                    </li>
                    
                    <li>
                      παιδιών που φοιτούν σε ειδικά σχολεία η σχολικές μονάδες ειδικής αγωγής (ανεξαρτήτως ηλικίας των παιδιών),
                    </li>

                    <li>
                      ατόμων με αναπηρία, τα οποία ανεξαρτήτως ηλικίας είναι ωφελούμενα σε δομές παροχής υπηρεσιών ανοιχτής φροντίδας για άτομα με αναπηρία.
                    </li>
                  </ul>
